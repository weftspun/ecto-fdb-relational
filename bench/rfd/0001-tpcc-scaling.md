# RFD 1: TPC-C scaling specification for the `bench/tpcc` port
...
`bench/tpcc/loader.ex` currently seeds a small, fixed dataset (2
...
`OL_I_ID`. `bench/tpcc/loader.ex`/`procedures.ex` currently use plain
...
## What this means for `bench/tpcc`

To be scale-factor-accurate, `bench/tpcc/loader.ex` needs:
